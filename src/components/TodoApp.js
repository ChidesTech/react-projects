...
return <>
     ...
     {/* 6. Map through the tasks and display them on the browser. */}
        ...
        {
            items.map(x => {
                return <div className="bg-light text-success border border-success fs-5 d-flex justify-content-between  m-3 p-3 rounded ">
                {x.newItem}  <i className="fa fa-trash text-danger"></i>
            </div>
            })
        }
